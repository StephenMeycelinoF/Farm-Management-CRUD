                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title" id="total-owners">
                                    Loading...
                                <p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title" id="total-animals">
                                    Loading...
                                <p>
                            </div>
                        </div>
            ...
            <div class="card card-stats">
                <div class="card-body ">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i class="bi bi-postcard-heart-fill text-danger"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                <p class="card-category">Total Pakan Ternak</p>
                                <p class="card-title" id="total-breeds">Loading...
                                <p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title" id="total-medicalRecords">Loading...
                                <p>
                            </div>
                        </div>
                    </div>
